<?php 
 ...
 $stmt->bind_param("ssss", $_FILES['pic']['name'], $_POST['owner_userID'], $_POST['owner_userID'], $_POST['owner_userID']);
 if($stmt->execute()){
 ...
 $stmt = $conn->prepare("SELECT id, image, owner_userID FROM restaurant_image");
 $stmt->execute();
 $stmt->bind_result($id, $image, $owner_userID);
 ...
 $temp['owner_userID'] = $owner_userID;
